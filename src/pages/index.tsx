  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With Restaurant Booking Engine, take the hassle out of table reservations. A seamless experience for customers, an efficient tool for restaurant staff."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Restaurant Booking Engine, take the hassle out of table reservations. A seamless experience for customers, an efficient tool for restaurant staff.`}
            </Text>
            <Box
